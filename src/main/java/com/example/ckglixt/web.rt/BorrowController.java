...
public class BorrowController {
    ...
    */
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(paramType="query", name = "bookAuthor", value = "作者", required = false, dataType = "String"),
            @ApiImplicitParam(paramType="query", name = "bookName", value = "名称", required = false, dataType = "String")
    })
